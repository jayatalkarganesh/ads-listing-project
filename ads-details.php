    ...
    <div class="section-padding">
      <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT users.UserID,phone,city,email, advertise.AdID,UID, title, categories,description, price, date, image 
            FROM users 
            INNER JOIN advertise ON users.UserID = advertise.UID 
            WHERE advertise.AdID = $id";
